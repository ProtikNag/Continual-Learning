...
task_data_list = [create_synthetic_graph(NUM_NODES, NUM_FEATURES, NUM_CLASSES, dissimilarity=i * 0.1) for i in
                  range(NUM_TASKS)]
...
plot_loss_curve(loss_for_all_data_together, title='All Data Together', case="All Data Together Non-IID")
plot_loss_curve(loss_for_naive_learning, title='Naive Learning', case="Naive Learning Non-IID")
plot_loss_curve(loss_for_mer, title='MER', case="MER Non-IID")
